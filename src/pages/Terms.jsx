    ...
    <div className="pt-32 pb-20 container mx-auto px-6 max-w-4xl">
      ...
      <div className="prose prose-stone max-w-none text-charcoal/80">
        ...
        <p>
          ...
          Silvia Skin Studio (“we,” “us” or “our”), concerning your access to
        ...
        <h3>2. Services</h3>
        <p>
          We provide skin treatments and massage therapy services. Appointments
          are subject to availability and our cancellation policy.
        </p>

        <h3>3. Cancellation Policy</h3>
        <p>
          We require at least 24 hours notice for cancellations. Cancellations
          made within 24 hours of the scheduled appointment time may incur a
          charge of 50% of the service fee.
        </p>
        ...
        <p>
          <em>
            Note: This is a placeholder document. Please consult with a legal
            professional.
          </em>
        </p>
      </div>
