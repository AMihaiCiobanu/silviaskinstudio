          ...
          {reviews.map((review, index) => (
            ...
            >
              ...
              <div className="mt-auto">
                <span className="font-serif font-medium text-charcoal block">{review.path}</span>
                <span className="text-xs text-charcoal/50 uppercase tracking-wider">Client</span>
              </div>
            </motion.div>
          ))}
        </div>
