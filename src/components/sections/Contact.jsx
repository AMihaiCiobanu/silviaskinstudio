  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <SectionTitle title="Visit The Studio" subtitle="Get In Touch" />

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Info */}
          <div className="space-y-8">
            <div className="bg-butter p-8 rounded-2xl border border-gold/10">
          ...
          {/* Map */}
          <div className="h-[500px] w-full bg-gray-100 rounded-2xl overflow-hidden shadow-lg relative">
            <iframe
